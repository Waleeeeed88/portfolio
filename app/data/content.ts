...
export const education = {
  ...
  degree: "Bachelors in Software Engineering  - Focus in Embedded Systems & Data engineering",
  gpa: "3.11/4.0",
  courses: [
    "Advanced OOP (EECS 2030)",
    "Data Structures & Algorithms (EECS 2011/ 3101)",
    "Software Design (EECS 3311)",
    "Database Management Systems (EECS 3421)",
    "Embedded Systems (EECS 2032)",
    "Digital Logic Design (EECS 3201)",
    "Intro to Computer Security (EECS 3482)",
  ],
};
